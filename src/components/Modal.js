            ...
            <div className="modal-content">
              <div className="modal-header orange">
                <img
                  ...
                  className="img-fluid mr-4 my-auto"
                  alt="user"
                />

                <span>
                  <h4 className="modal-title py-1">
                    <strong>{title}</strong>
                  </h4>
        ...
        <div className="modal fade" id="editProfile" data-target="#editProfile">
          <div className="modal-dialog">
            ...
            <div className="modal-footer">
              <ButtonContainer className="btn-primary">
                Save Changes
              </ButtonContainer>
              <ButtonContainer data-dismiss="modal" className="btn-danger">
                Cancel
              </ButtonContainer>
            </div>
          </div>
